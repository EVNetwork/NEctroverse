...
#define CMD_EMPIRE_POLOTICS_START CMD_USER_FLAGS_LEADER
#define CMD_EMPIRE_POLOTICS_END CMD_USER_FLAGS_WARMINISTER
#define CMD_EMPIRE_POLOTICS_TOTAL (CMD_USER_FLAGS_WARMINISTER - CMD_USER_FLAGS_LEADER)
