...
"The <b>Diplomatic Core</b> Reveals other families allies to the artefact holder!",
...
/*
 * New Artefact database structure, game no longer includes a "standard set"
 * Artefacts are now added in-game and enabled as desired.
 *
 */
