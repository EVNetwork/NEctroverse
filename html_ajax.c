...
if( refer ) {
	...
	httpString( cnt, "\t\t\tif( getnodevar(xmlhttp.responseXML,\"mail\") == 1 ) { changeimage(\"headermail\", \"http://www.nectroverse.net:8080/images/i09a.jpg\"); }\n" );
	httpString( cnt, "\t\t\tif( getnodevar(xmlhttp.responseXML,\"build\") == 1 ) { changeimage(\"headerbuild\", \"http://www.nectroverse.net:8080/images/i10a.jpg\"); }\n" );
	httpString( cnt, "\t\t\tif( getnodevar(xmlhttp.responseXML,\"aid\") == 1 ) { changeimage(\"headeraid\", \"http://www.nectroverse.net:8080/images/i11a.jpg\"); }\n" );
	httpString( cnt, "\t\t\tif( getnodevar(xmlhttp.responseXML,\"fleet\") == 1 ) { changeimage(\"headerfleet\", \"http://www.nectroverse.net:8080/images/i12a.jpg\"); }\n" );
	httpString( cnt, "\t\t\telse if( getnodevar(xmlhttp.responseXML,\"fleet\") == 2 ) { changeimage(\"headerfleet\", \"http://www.nectroverse.net:8080/images/i12b.jpg\"); }\n" );
	httpString( cnt, "\n" );
